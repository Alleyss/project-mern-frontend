...
export default function Carousel() {
  return (
    <div className="position-relative">
      <div className="carousel-container" style={{ maxHeight: "40px" }}>
        <div
          id="carouselExampleFade"
          className="carousel slide carousel-fade w-20"
          ...
          <div className="carousel-inner">
            <div className="carousel-item active">
              <img
                ...
                style={{ maxHeight: "40px", filter: "brightness(50%)" }}
                alt="Burger"
              />
            </div>
